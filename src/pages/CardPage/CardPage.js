        ...
        <div className='cart-page'>
            <div className='container'>
                <div className='breadcrumb'>
                    <ul className='breadcrumn-items flex'>
                        <li className='breadcrumn-item'>
                            <Link to='/'>
                                <i className='fas fa-home'></i>
                                <span className='breadcrumb-separator fs-16'></span>
                                            ...
                                            cartProducts.map(cartProduct => (
                                                <div className='cart-item grid' key={cartProduct.id}>
                                                    <div className='cart-item-img flex flex-column bg-white'>
                                                        ...
                                                        <button type='button' className='btn-square rm-from-cart-btn'
                                                            onClick={() => dispatch(removeFromCart({ id: cartProduct.id }))}>
                                                        ...
                                                        <div className='qty flex'>
                                                            ...
                                                            <div className='qty-change flex'>
                                                                <button type='button' className='qty-dec fs-14 text-light-blue'
                                                                    onClick={() => dispatch(toggleCartQty({ id: cartProduct.id, type: 'DEC' }))}>
                                ...
                                <div className='cart-right bg-white'>
                                    <div className='cart-summary text-light-blue'>
                                        ...
                                        <div className='cart-summary-total flex flex-between fs-18'>
                                            ...
                                            <span className='fs-6'>{formatPrice(totalAmount + deliveryCharge)} </span>
                                        </div>
                                    </div>
                                    <div className='cart-summary-btn'>
                                        <button type='button' className='btn-secondary'>Procees to Checkout </button>
                                    </div>
                                </div>
                            </div>
                        )
